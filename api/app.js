...
var alumnoMateriaRouter = require('./routes/alumnoMateria')
var docenteMateriaRouter = require('./routes/docenteMateria')
...
app.use('/alumat', alumnoMateriaRouter);
app.use('/docmat', docenteMateriaRouter);
